...
#Transformando orderdate somente em data, nao e mes.
...
app.layout = dbc.Container([
    ...
    dbc.Row([
        ...
        dbc.Col([
                    dbc.Card(
                        [
                                dbc.CardImg(
                                    src="assets/Robo-Minerador_metade-final_fundo-preto.jpg", 
                                    top = True,
                                    bottom=False),
    ...
    dbc.Col([
        ...
        dcc.Dropdown(id="ano_selecionado",
                    ...
                    multi=False,
                    value=2003,
                    style={'width': "40%"},className="text-center"
                    ), 
...
def update_map(ano_selecionado):
    ...
    title = "Mapa de Vendas EUA no ano de {}".format(ano_selecionado)
